...
.hubpill{border:1px solid var(--hair);background:#fff;border-radius:999px;
  padding:0 16px;font:inherit;font-size:11px;font-weight:500;
  white-space:nowrap;display:inline-flex;align-items:center;flex:none;
...
# Actual brand marks, fetched once and embedded as data URIs so the
# single-file demo stays single-file and offline.
CONN_LOGOS = {
    "AiSensy": "data:image/png;base64,",
    "Amazon": "data:image/png;base64,",
    "Blinkit": "data:image/png;base64,",
    "Flipkart": "data:image/png;base64,",
    "Instagram": "data:image/png;base64,",
    "Meesho": "data:image/png;base64,",
    "Route Mobile": "data:image/png;base64,",
    "Shiprocket": "data:image/png;base64,",
    "Shopify": "data:image/png;base64,",
    "Tally": "data:image/png;base64,",
    "WhatsApp": "data:image/png;base64,",
    "Zepto": "data:image/png;base64,",
    "Zoho Books": "data:image/png;base64,",
}
